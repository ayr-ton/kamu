  ...
  .config(['$routeProvider', '$translateProvider', '$httpProvider', 'toastrConfig', function ($routeProvider, $translateProvider, $httpProvider, toastrConfig) {
    ...
    $translateProvider
      .translations('en-US', {
        ...
        TEXT_AVAILABILIBY: ' of ',
        BOOK_AVAILABLE_QUANTITY: 'Availability',
      ...
      .translations('pt-BR', {
        ...
        TEXT_AVAILABILIBY: ' de ',
        BOOK_AVAILABLE_QUANTITY: 'Disponibilidade',
      ...
      .translations('es-EC', {
        ...
        BOOK_NUMBER_OF_PAGES: 'Páginas',
        TEXT_AVAILABILIBY: ' de ',
        BOOK_AVAILABLE_QUANTITY: 'Disponibilidad',
